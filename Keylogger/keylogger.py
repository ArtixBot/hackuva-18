...
#     for
#     print(dates)
testInput =[[123,456], ["cow@gmail.com", "cattle@yahoo.com", "cowt@gmail.com"]]
enterString = "zxcocow@gmail.com"
...
# param counter=0
# while true:
#   stream=string+input letter
#   for char in range(counter,len(stream)):
#
fruit = re.compile(r'(?:%s)' % '|'.join(e))
result = fruit.search(enterString)
print(result)
